...
const HeaderAuthProvider_1 = require("./auth/HeaderAuthProvider");
...
function normalizeClientOptions(options) {
    ...
    const headers = (0, headers_1.mergeHeaders)({
        ...
        "X-SDK-VERSION": (_a = options === null || options === void 0 ? void 0 : options.sdkVersion) !== null && _a !== void 0 ? _a : "1.15.0",
...
function normalizeClientOptionsWithAuth(options) {
    ...
    (_a = normalized.authProvider) !== null && _a !== void 0 ? _a : (normalized.authProvider = new HeaderAuthProvider_1.HeaderAuthProvider(normalizedWithNoOpAuthProvider));
    return normalized;
}
