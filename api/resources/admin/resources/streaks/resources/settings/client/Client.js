    ...
    __get(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : ((_h = (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.TrophyApiEnvironment.Production).admin, "streaks/settings"),
                method: "GET",
                headers: _headers,
            ...
            if (_response.ok) {
                return {
                    data: serializers.StreakSettings.parseOrThrow(_response.body, {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/streaks/settings");
        });
    }
    /**
    ...
    __update() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            const _response = yield core.fetcher({
                ...
                queryString: core.url.queryBuilder().mergeAdditional(requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams).build(),
                requestType: "json",
                body: serializers.admin.streaks.UpdateStreakSettingsRequest.jsonOrThrow(request, {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PATCH", "/streaks/settings");
        });
    }
}
