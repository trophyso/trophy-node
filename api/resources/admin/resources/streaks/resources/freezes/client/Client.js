    ...
    create(request, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                ...
                body: yield serializers.admin.streaks.CreateStreakFreezesRequest.jsonOrThrow(request, {
            ...
            if (_response.ok) {
                return yield serializers.CreateStreakFreezesResponse.parseOrThrow(_response.body, {
