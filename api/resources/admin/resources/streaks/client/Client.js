...
class StreaksClient {
    ...
    get freezes() {
        var _a;
        return ((_a = this._freezes) !== null && _a !== void 0 ? _a : (this._freezes = new Client_1.FreezesClient(this._options)));
    }
    /**
    ...
    restore(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__restore(request, requestOptions));
    }
    __restore(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : ((_h = (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.TrophyApiEnvironment.Production).admin, "streaks/restore"),
                method: "POST",
                headers: _headers,
                contentType: "application/json",
                queryString: core.url.queryBuilder().mergeAdditional(requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams).build(),
                requestType: "json",
                body: serializers.admin.RestoreStreaksRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            ...
            if (_response.ok) {
                return {
                    data: serializers.RestoreStreaksResponse.parseOrThrow(_response.body, {
            ...
            return (0, handleNonStatusCodeError_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/streaks/restore");
        });
    }
}
exports.StreaksClient = StreaksClient;
