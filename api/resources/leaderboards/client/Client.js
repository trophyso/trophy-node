...
class Leaderboards {
    ...
    all(requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.TrophyApiEnvironment.Default, "leaderboards"),
                method: "GET",
                headers: {
            ...
            if (_response.ok) {
                return yield serializers.leaderboards.all.Response.parseOrThrow(_response.body, {
    ...
    get(key, request = {}, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.TrophyApiEnvironment.Default, `leaderboards/${key}`),
                method: "GET",
                headers: {
                    "X-API-KEY": yield core.Supplier.get(this._options.apiKey),
                    "X-Fern-Language": "JavaScript",
            ...
            if (_response.ok) {
                return yield serializers.LeaderboardResponseWithRankings.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    breadcrumbsPrefix: ["response"],
     ...
     *     })
     */
    usersLeaderboards(userId, key, request = {}, requestOptions) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const { run } = request;
            const _queryParams = {};
            ...
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.TrophyApiEnvironment.Default, `users/${userId}/leaderboards/${key}`),
                method: "GET",
                headers: {
                    "X-API-KEY": yield core.Supplier.get(this._options.apiKey),
                    "X-Fern-Language": "JavaScript",
